...
extern double U_Em(double theta2, void* param);
extern double U_Em_theta(double lambda, void* param);
extern double P_Em(double theta2Min, double theta2Max, double lambdaMin, double lambdaMax, double d2);
...
extern void writeImageJPEG(double* image, int width, int height, string output_file);
extern void writeImagePGM(int* image, int width, int height, string output_file);
extern void writeImagePGM(double* image, int width, int height, string output_file);
...
extern int nlsq_FLIC_HABC_pixel_MS (double* Images, int pixel, int nrows, int ncols, int nimages, double* ZGAP,
		double* FLIC, double* DERIV, double& H, double& A, double& B, double& C, double& R, double h_LB, double h_UB, double stepSize);
extern int nlsq_FLIC_HABCQ_pixel_MS (double* Images, int pixel, int nrows, int ncols, int nimages, double* ZGAP,
		double* FLIC, double* DERIV, double& H, double& A, double& B, double& C, double& R, double h_LB, double h_UB, double stepSize);
...
extern int nlsq_FLIC_HABC_pixel(double* Images, int pixel, int nrows, int ncols, int nimages, double* ZGAP,
		double* FLIC, double* DERIV, double& H, double& A, double& B, double& L, double& R, double h_LB, double h_UB);
extern int nlsq_FLIC_HABCQ_pixel(double* Images, int pixel, int nrows, int ncols, int nimages, double* ZGAP,
		double* FLIC, double* DERIV, double& H, double& A, double& B, double& L, double& R, double h_LB, double h_UB);
